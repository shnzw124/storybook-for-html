...
/*! ModuleConcatenation bailout: Cannot concat with ./node_modules/@popperjs/core/lib/enums.js */
  ...
  modifiers.forEach(function (modifier) {
    ...
    .filter(function (value, index, self) {
      ...
      switch (key) {
        ...
        case 'phase':
          if (enums["g" /* modifierPhases */].indexOf(modifier.phase) < 0) {
            console.error(format(INVALID_MODIFIER_ERROR, modifier.name, '"phase"', "either " + enums["g" /* modifierPhases */].join(', '), "\"" + String(modifier.phase) + "\""));
          }
    ...
    var instance = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          ...
          if (getBasePlacement(state.options.placement) === enums["a" /* auto */]) {
